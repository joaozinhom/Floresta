...
test_definitions = [
    ("addnodev2", "floresta-cli.addnode-v2", "AddnodeTestV2"),
    ("addnodev1", "floresta-cli.addnode-v1", "AddnodeTestV1"),
    ("reorg_chain", "florestad.reorg-chain", "ChainReorgTest"),
    ("getbestblockhash", "floresta-cli.getbestblockhash", "GetBestblockhashTest"),
    ("getblockcount", "floresta-cli.getblockcount", "GetBlockCountTest"),
    ("uptime", "floresta-cli.uptime", "UptimeTest"),
    ("restart", "florestad.restart", "TestRestart"),
    ("connect", "florestad.connect", "CliConnectTest"),
    ("stop", "floresta-cli.stop", "StopTest"),
    ("ping", "floresta-cli.ping", "PingTest"),
    ("getrpcinfo", "floresta-cli.getrpcinfo", "GetRpcInfoTest"),
    ("getblockhash", "floresta-cli.getblockhash", "GetBlockhashTest"),
    ("tls", "florestad.tls", "TestSslInitialization"),
    ("getroots", "floresta-cli.getroots", "GetRootsIDBLenZeroTest"),
    ("getblock", "floresta-cli.getblock", "GetBlockTest"),
    ("getmemoryinfo", "floresta-cli.getmemoryinfo", "GetMemoryInfoTest"),
    ("getblockheader", "floresta-cli.getblockheader", "GetBlockheaderHeightZeroTest"),
    ("getpeerinfo", "floresta-cli.getpeerinfo", "GetPeerInfoTest"),
    ("tls_fail", "florestad.tls-fail", "TestSslFailInitialization"),
    ("getblockchaininfo", "floresta-cli.getblockchaininfo", "GetBlockchaininfoTest"),
    ("example_bitcoin", "example.bitcoin", "BitcoindTest"),
    ("example_electrum", "example.electrum", "ElectrumTest"),
    ("example_functional", "example.functional", "FunctionalTest"),
    ("example_integration", "example.integration", "IntegrationTest"),
    ("example_utreexod", "example.utreexod", "UtreexodTest"),
]

TEST_REGISTRY = {
    name: import_test_class(module, cls) for name, module, cls in test_definitions
}
...
def run_test_direct(test_name, test_class, verbose=False):
    ...
    try:
        ...
        # Suppress output unless verbose mode is enabled
        if not verbose:
